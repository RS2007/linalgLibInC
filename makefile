...
program1: matrix.o test.o
	gcc -Wall -pedantic -fsanitize=address -Werror -g matrix.o  test.o  -o program1

matrix.o: matrix.c
	gcc -Wall -pedantic -fsanitize=address -Werror -g -c matrix.c -o matrix.o

test.o: test.c
	gcc -Wall -pedantic -fsanitize=address -Werror -g -c test.c -o test.o
